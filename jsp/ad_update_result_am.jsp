...
<p class="text-right"><a href="AdManageStuResult?action=sjg&rn=${xz.uname}&time=am"  onclick='return window.confirm("您确定要将座位状态改为未占用吗？")' class="btn btn-default btn-lg active">取消上午座位</a></p>
